...
/**
 * The SMTPTest model module.
 * @module model/SMTPTest
 * @version 1.0.0
 */
class SMTPTest {
    /**
     * Constructs a new <code>SMTPTest</code>.
     * @alias module:model/SMTPTest
     */
    constructor() { 
        
        SMTPTest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SMTPTest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SMTPTest} obj Optional instance to populate.
     * @return {module:model/SMTPTest} The populated <code>SMTPTest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SMTPTest();
            ...
            if (data.hasOwnProperty('strEmailHeaders')) {
                obj['strEmailHeaders'] = ApiClient.convertToType(data['strEmailHeaders'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>SMTPTest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SMTPTest</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['strEmailHeaders'] && !(typeof data['strEmailHeaders'] === 'string' || data['strEmailHeaders'] instanceof String)) {
            throw new Error("Expected the field `strEmailHeaders` to be a primitive type in the JSON string but got " + data['strEmailHeaders']);
        }
        // ensure the json data is a string
 ...
 * @member {String} uuid
 */
SMTPTest.prototype['uuid'] = undefined;

/**
 * @member {Boolean} enabled
 */
SMTPTest.prototype['enabled'] = undefined;

/**
 * @member {String} host
 */
SMTPTest.prototype['host'] = undefined;

/**
 * @member {String} hello_hostname
 */
SMTPTest.prototype['hello_hostname'] = undefined;

/**
 * @member {Number} port
 */
SMTPTest.prototype['port'] = undefined;

/**
 * @member {String} auth_protocol
 */
SMTPTest.prototype['auth_protocol'] = undefined;

/**
 * @member {String} username
 */
SMTPTest.prototype['username'] = undefined;

/**
 * @member {Array.<Object>} email_headers
 */
SMTPTest.prototype['email_headers'] = undefined;

/**
 * @member {Number} max_conns
 */
SMTPTest.prototype['max_conns'] = undefined;

/**
 * @member {Number} max_msg_retries
 */
SMTPTest.prototype['max_msg_retries'] = undefined;

/**
 * @member {String} idle_timeout
 */
SMTPTest.prototype['idle_timeout'] = undefined;

/**
 * @member {String} wait_timeout
 */
SMTPTest.prototype['wait_timeout'] = undefined;

/**
 * @member {String} tls_type
 */
SMTPTest.prototype['tls_type'] = undefined;

/**
 * @member {Boolean} tls_skip_verify
 */
SMTPTest.prototype['tls_skip_verify'] = undefined;

/**
 * @member {String} strEmailHeaders
 */
SMTPTest.prototype['strEmailHeaders'] = undefined;

/**
 * @member {String} password
 */
SMTPTest.prototype['password'] = undefined;

/**
 * @member {String} email
 */
SMTPTest.prototype['email'] = undefined;
