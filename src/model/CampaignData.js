...
class CampaignData {
    ...
    /**
     * Validates the JSON data with respect to <code>CampaignData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CampaignData</code>.
     */
 ...
 * @member {Number} id
 */
CampaignData.prototype['id'] = undefined;

/**
 * @member {String} created_at
 */
CampaignData.prototype['created_at'] = undefined;

/**
 * @member {String} updated_at
 */
CampaignData.prototype['updated_at'] = undefined;

/**
 * @member {Number} CampaignID
 */
CampaignData.prototype['CampaignID'] = undefined;

/**
 * @member {Number} views
 */
CampaignData.prototype['views'] = undefined;

/**
 * @member {Number} clicks
 */
CampaignData.prototype['clicks'] = undefined;

/**
 * @member {Array.<module:model/BounceDataResultsInnerCampaign>} lists
 */
CampaignData.prototype['lists'] = undefined;

/**
 * @member {String} started_at
 */
CampaignData.prototype['started_at'] = undefined;

/**
 * @member {Number} to_send
 */
CampaignData.prototype['to_send'] = undefined;

/**
 * @member {Number} sent
 */
CampaignData.prototype['sent'] = undefined;

/**
 * @member {String} uuid
 */
CampaignData.prototype['uuid'] = undefined;

/**
 * @member {module:model/CampaignData.TypeEnum} type
 */
CampaignData.prototype['type'] = undefined;

/**
 * @member {String} name
 */
CampaignData.prototype['name'] = undefined;

/**
 * @member {String} subject
 */
CampaignData.prototype['subject'] = undefined;

/**
 * @member {String} from_email
 */
CampaignData.prototype['from_email'] = undefined;

/**
 * @member {String} body
 */
CampaignData.prototype['body'] = undefined;

/**
 * @member {String} send_at
 */
CampaignData.prototype['send_at'] = undefined;

/**
 * @member {String} status
 */
CampaignData.prototype['status'] = undefined;

/**
 * @member {module:model/CampaignData.ContentTypeEnum} content_type
 */
CampaignData.prototype['content_type'] = undefined;

/**
 * @member {Array.<String>} tags
 */
CampaignData.prototype['tags'] = undefined;

/**
 * @member {Number} template_id
 */
CampaignData.prototype['template_id'] = undefined;

/**
 * @member {String} messenger
 */
CampaignData.prototype['messenger'] = undefined;
